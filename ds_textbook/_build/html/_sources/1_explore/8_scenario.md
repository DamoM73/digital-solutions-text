...
First Mikey is now in a relationship, and it is getting serious. His partner, who is also interested in hangman, has moved in. Mikey would like to setup the game with different users so his partner can play whilst not ruining Mikey's record.
...
Mikey has also found a dictionary database with more words than the current list, so he would like the program to use this. This database has other details that he thinks might be useful, but he's not sure how to use them yet.
